...
class ButtonHandler:
    ...
    def __init__(
        ...
        try:
            ...
            raise HardwareError(
                f"Failed to initialize buttons: {str(e)}",
                component="button",
        ...
        try:
            ...
            raise HardwareError(
                f"Failed to setup button handlers: {str(e)}",
                component="button",
                error_type="setup"
            )
    ...
    def _enter_menu(self) -> None:
        ...
        try:
            ...
            if not self.state_manager.enter_utility():
                raise StateError(
                    "Failed to enter utility state",
                    current_state=self.state_manager.current_state,
                    target_state="utility"
                )
            ...
            try:
                ...
                raise DisplayError(
                    f"Failed to update display: {str(e)}",
                    display_type="lcd",
                    error_type="write"
                )
            ...
            try:
                ...
                raise HardwareError(
                    f"Failed to set button handlers: {str(e)}",
                    component="button",
                    error_type="callback"
                )
    ...
    def cleanup(self) -> None:
        ...
        try:
            ...
            raise HardwareError(
                f"Failed to cleanup buttons: {str(e)}",
                component="button",
                error_type="cleanup"
            )
